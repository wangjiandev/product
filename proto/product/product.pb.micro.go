...
type ProductService interface {
	...
	FindAllProduct(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*ResponseProductList, error)
}
...
func (c *productService) FindAllProduct(ctx context.Context, in *RequestAll, opts ...client.CallOption) (*ResponseProductList, error) {
	req := c.c.NewRequest(c.name, "Product.FindAllProduct", in)
	out := new(ResponseProductList)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
	}
...
type ProductHandler interface {
	...
	FindAllProduct(context.Context, *RequestAll, *ResponseProductList) error
}
...
func RegisterProductHandler(s server.Server, hdlr ProductHandler, opts ...server.HandlerOption) error {
	type product interface {
		...
		FindAllProduct(ctx context.Context, in *RequestAll, out *ResponseProductList) error
	}
	type Product struct {
		product
	}
...
func (h *productHandler) FindAllProduct(ctx context.Context, in *RequestAll, out *ResponseProductList) error {
